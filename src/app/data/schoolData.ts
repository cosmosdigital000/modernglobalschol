// School data for Modern Global School website
...
export const uspData = [
  ...
  { icon: "fas fa-chart-bar", title: "Individual Progress Tracking", desc: "Regular assessments with personalized feedback so every child reaches their potential.", color: "#DC2626" },
...
export const timingData = [
  ...
  { label: "Saturday", time: "7:30 AM – 12:30 PM" },
  { label: "Office Hours", time: "9:00 AM – 4:00 PM" },
  { label: "Assembly", time: "7:30 AM – 7:50 AM" },
  { label: "Lunch Break", time: "11:30 AM – 12:00 PM" },
...
export const admissionSteps = [
  { step: "1", title: "Fill the Enquiry Form", desc: "Complete the online form or visit our admission office in person", icon: "fas fa-file-alt" },
  { step: "2", title: "Document Submission", desc: "Submit all required documents for verification by the office", icon: "fas fa-folder-open" },
  { step: "3", title: "Entrance Assessment", desc: "Age-appropriate interaction/test for admission to Class V and above", icon: "fas fa-pencil-alt" },
  { step: "4", title: "Fee Payment & Enrollment", desc: "Pay the admission fee and complete the enrollment formalities", icon: "fas fa-check-circle" }
];
...
export const footerQuickLinks = [
  ...
  { l: "About Us", h: "/#about" },
  { l: "Academics", h: "/academics" },
  { l: "Admission 2026–27", h: "/#admission" },
  { l: "Facilities", h: "/facilities" },
  { l: "Notice Board", h: "/notice-board" },
  { l: "Mandatory Disclosure", h: "/mandatory-disclosure" },
  { l: "Gallery", h: "/gallery" },
...
export const footerCareers = [
  { l: "Teaching Jobs", h: "/#contact" },
  { l: "Non-Teaching Jobs", h: "/#contact" },
  { l: "Admin Jobs", h: "/#contact" }
];
